...
fs.writeFileSync(
  ...
  [
    "# Codex Asset Pack",
    "",
    "1. Generate ImageGen assets from `imagegen_prompts.md` as PNG/WebP/JPG.",
    "2. Generate HyperFrames b-roll assets from `hyperframes_prompts.md` as MP4.",
    "3. Edit `codex_asset_import_template.json` so each generated asset has a valid `local_path` or `source_url`.",
    "4. Dry-run import:",
    "   `npm run codex:asset-pack:import -- --file <path-to-template>`",
    "5. Apply import:",
    "   `npm run codex:asset-pack:import -- --file <path-to-template> --apply`",
    "",
    "Do not use SVG in the primary Codex asset workflow.",
    "",
  ].join("\n"),
  "utf8",
);
